...
def Filter(data,filterMethod,averageMethod,window,writePath_dataFrames):
#
...
##	Run the filter twice but no more than this.
	...
	while N<Nmax:
		N=N+1
		XSpikes = Filter(UxNew,window,data,averageMethod,'Ux')
		YSpikes = Filter(UyNew,window,data,averageMethod,'Uy')
#
